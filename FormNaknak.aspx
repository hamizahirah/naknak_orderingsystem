<%@ Page Language="C#" MasterPageFile="~/Naknak.Master" AutoEventWireup="true" CodeBehind="FormNaknak.aspx.cs" 
    Inherits="NAKNAK.FormNaknak" %>
        ...
        <p>
            <asp:GridView ID="GridViewItems" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="ItemID" DataSourceID="SqlDataSourceItems" PageSize="3" OnSelectedIndexChanged="GridViewItems_SelectedIndexChanged" CssClass="grid-view">
                <Columns>
                    ...
                    <asp:ImageField DataImageUrlField="ItemImage" DataImageUrlFormatString="ImagesNaknak/{0}" HeaderText="Variety of Food">
